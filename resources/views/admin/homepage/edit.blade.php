...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="w-100">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{route('admin.homepage.index')}}">Список изображений</a></li>
        </ol>
    </nav>
    @if (count($errors) > 0)
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.homepage.update', [$image])}}" method="POST" class="form py-4"
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="form-group row border-bottom py-3">
                                    <label for="main_title" class="col-sm-2 col-form-label">
                                        Название</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="main_title" id="main_title" value="{{$image->main_title}}">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom py-3">
                                    <label for="main_description" class="col-sm-2 col-form-label">
                                        Описание</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="main_description" id="main_description" value="{{$image->main_description}}">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom py-3">
                                    ...
                                    <div class="image-upload-container" style="max-width:600px;">
                                        ...
                                        <div class="image-preview-container"
                                            ...
                                            <div class="image-preview" data-init-image="{{assetImage($image->main_cover)}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
