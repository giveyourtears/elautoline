...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="w-100">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{route('admin.auction.index')}}">Аукционные сборы</a></li>
        </ol>
    </nav>
    @if (count($errors) > 0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="/admin/auction/{{$fee->id}}/edit" class="btn btn-success mr-1">
                                                <span class="bi bi-pencil-fill"></span>
                                            </a>
                                            <form action="{{ URL::route('admin.auction.destroy', $fee->id) }}" method="POST" class="btn btn-danger">
