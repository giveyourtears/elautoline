...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="w-100">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{route('admin.vehicles.index')}}">Типы транспорта</a></li>
        </ol>
    </nav>
    @if (count($errors) > 0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="/admin/vehicles/{{$vehicle->id}}/edit" class="btn btn-success mr-1">
                                                <span class="bi bi-pencil-fill"></span>
                                            </a>
{{--                                            <a href="{{ URL::route('admin.images.index', $car->id) }}" class="btn btn-success mr-1">--}}
{{--                                                <span class="bi bi-card-image"></span>--}}
{{--                                            </a>--}}
                                            <form action="{{ URL::route('admin.vehicles.destroy', $vehicle->id) }}" method="POST" class="btn btn-danger">
